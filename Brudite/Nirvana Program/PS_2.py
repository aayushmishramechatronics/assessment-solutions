...
#1 ≤ q ≤ 10 ^ 5
#1 ≤ ai,x ≤ 10 ^ 9
#1 ≤ v ≤ number of versions created
#1 ≤ l ≤ r ≤ n
...
#Query 2 1 2 4 Sum of [2, 3, 4] = 2 + 3 + 4 = 9
#Update 1 1 3 10 -> Set index 3 to 10 in version 1, creating version 2: [1, 2, 10, 4, 5]
#Query 2 2 1 5 -> Sum of [1, 2, 10, 4, 5] = 22
#Query 2 1 3 3 -> Sum at index 3 in version 1 = 3
#Query 2 2 3 3 -> Sum at index 3 in version 2 = 10
...
#Update 1 1 2 5 -> Set Index 2 to 5 in version 1, creating version 2: [1, 5, 1]
#Query 2 2 1 3 -> Sum of [1, 5, 1] = 7
#Query 2 1 1 3 -> Sum of [1, 1, 1]= 3
